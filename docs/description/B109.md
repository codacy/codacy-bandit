...
- <a href="index.html" class="reference internal" shape="rect">Test
  ...
  - <a href="index.html#complete-test-plugin-listing"
    ...
    - <a href="#" class="current reference internal" shape="rect">B109:
...
- <a
  href="../_sources/plugins/b109_password_config_option_not_marked_secret.rst.txt"
  rel="nofollow" shape="rect">View page source</a>

------------------------------------------------------------------------

# B109: password_config_option_not_marked_secret<a href="#b109-password-config-option-not-marked-secret"
class="headerlink" shape="rect" title="Link to this heading"></a>
...
- <a
  href="https://security.openstack.org/guidelines/dg_protect-sensitive-data-in-files.html"
  class="reference external"
  shape="rect">https://security.openstack.org/guidelines/dg_protect-sensitive-data-in-files.html</a>

Added in version 0.10.0.

Deprecated since version 1.5.0: This plugin was removed

<a href="b108_hardcoded_tmp_directory.html"
class="btn btn-neutral float-left" rel="prev" accesskey="p" shape="rect"
title="B108: hardcoded_tmp_directory">Previous</a>
<a href="b110_try_except_pass.html" class="btn btn-neutral float-right"
rel="next" accesskey="n" shape="rect"
title="B110: try_except_pass">Next</a>
